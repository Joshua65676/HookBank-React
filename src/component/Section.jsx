...
export default function Main(){
    return(
        <section className="container justify-around pt-20 space-x-10 md:flex">
          <div className="w-full pt-20 ml-20 space-y-20">
            ...
            <div className="md:flex" >
              ...
              <h1 className="space-y-10 text-6xl font-semibold text-white md:font-bold md:text-7xl -ml-14 md:ml-0">
                The Next
          ...
          <div className="w-full pt-10 pb-10 md:pt-0 md:pb-0 ">
            <img src={Robot} alt="robot" className="-ml-10 md:w-full md:ml-10"/>
          </div>
