    ...
    return(
        <footer className="w-[1400px] h-[418px]">
         <div className="pt-20 space-y-10 md:ml-20 md:flex md:space-x-36 md:space-y-0">
           ...
           <div className="pt-5 ml-5 md:flex md:space-x-28 md:ml-0">
          ...
          <div className="pt-10">
            ...
            <div className="pt-10 space-y-10 md:justify-between md:ml-20 md:flex md:space-y-0">
              <p className="w-3/12 space-x-1 text-xl text-center text-textColor">
                <span className=""> Copyright </span>
                 <span className="font-bold"> &copy; </span>
                <span className="font-semibold">2024 HooBank. All Rights Reserved.</span>
              </p>

              <div className="flex ml-20 space-x-2 md:mr-14 md:ml-0">
